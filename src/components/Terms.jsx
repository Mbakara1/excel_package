...
import { ChevronDown, ChevronUp, ShieldCheck, Clock, FileText, Scale } from 'lucide-react';

const terms = [
  {
    id: 'payment',
    title: 'Payment & Booking',
    icon: <Star className="w-5 h-5" />, // Note: Using some variety here
    content: (
...
// Re-using icon imports just to be safe
